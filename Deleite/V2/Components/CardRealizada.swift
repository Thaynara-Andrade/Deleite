...
//  Deleite
//
//  Created by Marília de Sousa on 29/11/23.
//

import SwiftUI

struct CardRealizada: View {
...
#Preview {
    CardRealizada(cardTitle: "Coleta de Leite Materno", cardTitle2 :"21 de abril de 2023", cardTitle3: "Manhã", cardTitle4: "Status: Realizada", cardImage: Image(systemName: "checkmark.circle.fill"))
}
