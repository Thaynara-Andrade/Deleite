...
#Preview {
    CardAgendadoView(cardTitle: "Recebimento de pote", cardTitle2: "09 de maio de 2023", cardTitle3: "Solicitação Agendada", cardImage: Image("pote"), cardImage2: Image(systemName: "clock.fill"))
}
